//this is the top level test bench for the whole system
//focuses on wiring of tasks and how those states and outputs 
//			effect the external behavior of the FPGA (LED outputs, HEX display)
